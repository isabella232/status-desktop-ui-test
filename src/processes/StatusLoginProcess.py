...
class StatusLoginProcess(StatusProcess):
    ...
    def __init__(self, account, password=None, isBiometrics=False):
        self.__account = account
        self.__password = password
        self.__byKeycard = (password == None)
    ...
    def __execute_password_steps(self):           
        ...
        # Step 1:            
        self.__step1_result = self.__step_user_selects_account(self.__account)
         
        # Step 2:
        self.__step2_result = self.__step_user_enters_password(self.__password)
    ...
    def __step_user_selects_account(self, account):        
        result = False
        if self.__login_screen and self.__login_screen.is_loaded():
            if self.__login_screen.open_accounts_selector_popup():
                ...
                if accounts_popup.is_loaded():
                    result = accounts_popup.select_account(account)
        return result
